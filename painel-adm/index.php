...
if(@$_SESSION['id_usuario'] == null || @$_SESSION['nivel'] != "Admin"){
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>">Professores</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">Alunos</a>
                        </div>
                    </div>
                </li>
