            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>">Materiais de estudo</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">Estudos complementares</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu3 ?>">Atividades</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu4 ?>">Revisão do Assunto</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu5 ?>">Desafio</a>



                            <!--<h6 class="collapse-header">Funções Trigonométricas:</h6> -->
                            <h6 class="collapse-header">Ângulos II:</h6>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
                        ...
                        <span>Funções Trigonométricas</span>
...
<df-messenger
  intent="WELCOME"
  chat-title="Curumim Assistente"
  chat-icon="https://imgur.com/tx1neHH.png"
  agent-id="99180b3c-bb9f-48e7-9282-f6a81556ae57"
  language-code="pt-br"
></df-messenger>
