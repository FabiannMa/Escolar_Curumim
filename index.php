...
<head>
	...
	* { -webkit-box-sizing:border-box; -moz-box-sizing:border-box; -ms-box-sizing:border-box; -o-box-sizing:border-box; box-sizing:border-box; }
	...
	body { 
		...
		background: #040a38;
 background-image: linear-gradient(to bottom, rgba(250,250,210,1), rgba(46, 139, 87,1),rgba(0,0,0,1));
}
	.login { 
		position: absolute;
		top: 50%;
...
<body>
	...
	<div class="login">
		...
		<form method="post" action="autenticar.php">
			...
			<div align="center" class="mt-2">
				<small><a href="" data-toggle="modal" data-target="#modalRecuperar" title="REGISTRAR-SE" class="text-light">REGISTRAR-SE</a></small>
			</div>
		</form>
	</div>
