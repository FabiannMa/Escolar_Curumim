...
CREATE TABLE `postagem_usuario` (
  `pos_usu_id_pk` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `pos_usu_status` int NOT NULL,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`pos_usu_id_pk`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `postagem_usuario`
--

LOCK TABLES `postagem_usuario` WRITE;
/*!40000 ALTER TABLE `postagem_usuario` DISABLE KEYS */;
/*!40000 ALTER TABLE `postagem_usuario` ENABLE KEYS */;
UNLOCK TABLES;
