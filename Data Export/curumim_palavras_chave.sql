...
CREATE TABLE `palavras_chave` (
  `pal_id_pk` int unsigned NOT NULL AUTO_INCREMENT,
  `pal_texto` varchar(30) NOT NULL,
  PRIMARY KEY (`pal_id_pk`)
...
INSERT INTO `palavras_chave` VALUES (1,'Trigonometria 1'),(2,'Ângulos'),(3,'Formas'),(4,'Triangulos');
